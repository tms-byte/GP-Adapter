...
class ImageNet():
    ...
    def __init__(self, root, num_shots, preprocess, dataset_dir=None):
        ...
        self.train = ImageFolder(root=os.path.join(self.image_dir, 'train'), transform=train_preprocess)
        self.val   = ImageFolder(root=os.path.join(self.image_dir, 'val'), transform=test_preprocess)
        self.test = ImageFolder(root=os.path.join(self.image_dir, 'val'), transform=test_preprocess)
